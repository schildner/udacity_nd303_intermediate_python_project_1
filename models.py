...
class NearEarthObject:
    ...
    """
    # TODO-> DONE: How can you, and should you, change the arguments to this constructor?
    ...
    def fullname(self):
        ...
        # TODO-> DONE: Use self.designation and self.name to build a fullname for this object.
...
class CloseApproach:
    ...
    def time_str(self):
        ...
        """
        # TODO-> DONE: Use this object's `.time` attribute and the `datetime_to_str` function to
        # build a formatted representation of the approach time.
        # TODO-> Does not apply here: Use self.designation and self.name to build a fullname for this object.
    ...
    def __str__(self):
        ...
        # method for examples of advanced string formatting.
        # DONE: variadic keyword **info param removed,
        #       introduced positional params for mandatory (all) data expected in close approach obj.
